...
class MainThread(QThread):
    ...
    def jarvisfunc(self):
        while True:
            ...
            elif "start command prompt" in self.query:
            ...
            elif "python code" in self.query:
    ...
    def jarvisfuncmobile(self):
        while True:
            ...
            elif "send mail from download" in self.query:
                try:
